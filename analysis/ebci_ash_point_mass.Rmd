---
title: "Compare Empirikos and ash_point_mass"
author: "Dongyue Xie"
date: "2022-01-26"
...
How does the Empirikos upper bound(no point mass) compare with ash(with point mass)?
...
We first look at using Gaussian scale mixture as the prior.  The prior class is $g\in SN(0.1,15.6,1.1)$. For ash add point mass at 0.
...
```{r}
par(mfrow=c(1,3))
plot_res(method = "dkw_scalemix",idx=1:11,color = rgb(1, 0.6, 0,0.5),ylim=c(0,0.2))
plot_res(method = "kde_scalemix",idx=1:11,color = rgb(0.4, 0, 0,0.4),ylim=c(0,0.2))
plot_res(method = "amari_scalemix",idx=1:11,color = rgb(0, 0, 0.8,0.4),ylim=c(0,0.2))
```
...
```{r}
par(mfrow=c(1,3))
plot_res(method = "dkw_scalemix",idx=1:6,color = rgb(1, 0.6, 0,0.5),ylim=c(0,0.015))
plot_res(method = "kde_scalemix",idx=1:6,color = rgb(0.4, 0, 0,0.4),ylim=c(0,0.015))
plot_res(method = "amari_scalemix",idx=1:6,color = rgb(0, 0, 0.8,0.4),ylim=c(0,0.015))
```
