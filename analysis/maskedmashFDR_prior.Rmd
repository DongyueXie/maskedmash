...
Generate 2000 samples from 4 multivariate uniform distribution(marginally [-3,3], obtained from transforming multivariate normals)

```{r,fig.width=9,fig.height=7}
out = readRDS('output/maskedmashFDR/uniform_prior_range3K4N2000.rds')
plot.fdr(out)
```
...
Generate 2000 samples from 4 multivariate uniform distribution(marginally [0,3]).

```{r,fig.width=9,fig.height=7}
out = readRDS('output/maskedmashFDR/halfuniform_prior_range3K4N2000.rds')
plot.fdr(out)
```
